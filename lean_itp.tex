...
Czytelnik powinien zwrócić uwagę na jego dokładne sformuowanie -- korzystamy z faktu, że $(\NN_+, \cdot)$ jest półgrupą przemienną.
\begin{minted}{lean4}
have f2_eq_2 : f 2 = 2 := by
  specialize h 2 2
...
Wracając do konguencji, będziemy chcieli udowodnić poniższe twierdzenie przez indukcję.
\begin{theorem}
...
Sformuowanie ostatniego kroku można uprościć, pisząc \Lean{_ = _ := by ring}, ponieważ ostateczny wynik jest naszym celem, więc Lean go zna. Poza tym, w niektórych krokach możemy użyć taktyki \Lean{gcongr}, która automatycznie stosuje pewne twierdzenia dotyczące kongruencji. Ostatecznie otrzymujemy:
